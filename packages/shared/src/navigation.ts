...
export const NAV_MODULES: NavModule[] = [
  ...
  },
  {
    ...
    roles: [Role.ADMIN],
    children: [
      { id: "overview", label: "Overview", path: "/hrms/overview" },
      { id: "employees", label: "Employee Management", path: "/hrms/employees" },
      { id: "attendance", label: "Attendance Management", path: "/hrms/attendance" },
      { id: "shifts", label: "Shift Management", path: "/hrms/shifts" },
      { id: "leave", label: "Leave Management", path: "/hrms/leave" },
      { id: "allowances", label: "Allowance & Deduction", path: "/hrms/allowances" },
      { id: "promotions", label: "Promotion & Salary Increment", path: "/hrms/promotions" },
      { id: "loans", label: "Loans", path: "/hrms/loans" },
      { id: "performance", label: "Performance & Incentives", path: "/hrms/performance" },
      { id: "payroll", label: "Payroll & Payslips", path: "/hrms/payroll" },
    ],
  },
  {
    id: "reports",
