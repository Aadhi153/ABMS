...
const CREATE_DEPARTMENT = gql`
  mutation CreateDepartmentTab($input: CreateDepartmentInput!) {
...
const UPDATE_DEPARTMENT = gql`
  mutation UpdateDepartmentTab($id: String!, $input: CreateDepartmentInput!) {
...
const DELETE_DEPARTMENT = gql`
  mutation DeleteDepartmentTab($id: String!) {
...
export default function DepartmentsTab() {
  const { data, loading, refetch } = useQuery<{ departments: Department[] }>(DEPARTMENTS_QUERY);
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (editing) {
        await updateDepartment({ variables: { id: editing.id, input } });
    ...
    <div className="space-y-4">
      ...
      <Dialog open={!!deleteTarget} onOpenChange={(o) => !o && setDeleteTarget(null)}>
        <DialogContent>
          ...
          <p className="text-sm text-muted-foreground">Departments with employees assigned cannot be deleted.</p>
          <DialogFooter>
